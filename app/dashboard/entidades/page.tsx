...
// Ajuste de ruta: 3 niveles hacia arriba para entrar en src/lib
...
export default function EntidadesPage() {
  ...
  const Input = ({ label, icon: Icon, value, onChange, type = "text", placeholder = "" }: any) => (
    <div className="space-y-2.5">
      <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] ml-5 flex items-center leading-none">
        <Icon className="w-3.5 h-3.5 mr-2 text-indigo-500" />
        {label}
      </label>
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b dark:border-white/5 pb-10 text-slate-900 dark:text-white">
        <div className="space-y-2">
          <h1 className="text-6xl font-black tracking-tighter uppercase italic leading-none">Entidades</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 text-slate-900 dark:text-white font-bold">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="bg-indigo-600 p-8 rounded-[2.5rem] flex flex-col justify-center text-center shadow-2xl ring-[12px] ring-indigo-50 dark:ring-indigo-500/5 group hover:scale-[1.02] transition-transform">
                     <label className="text-[10px] font-black text-indigo-200 uppercase tracking-widest mb-1 opacity-70 italic leading-none">SaaS Service Fee (%)</label>
