...
export default function GerenciaPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      let cap = 0;
      snap.docs.forEach(d => cap += (d.data().financiero?.montoBruto || 0));
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <h1 className="text-3xl font-black text-white mb-2">Centro de Gerencia</h1>
      <p className="text-gray-500 mb-10">Resumen operativo en tiempo real de {entidadData?.nombre}.</p>
